...
import { login, listarClientes, criarCliente, editarCliente, obterClientePorId, excluirCliente } from '../controllers/ClienteController.js';
...
router.delete('/:id', authMiddleware(['admin']), excluirCliente); // Nova rota para exclusão
